...
public class ATMController {
	...
	@Autowired
	JsonResponseTransformService transformService;
	@Autowired
	HttpRequestService httpRequestService;

	public ATMController(@Value("${atm.request.url}") String URL, JsonResponseTransformService transformService,
			HttpRequestService httpRequestService) {
		this.URL = URL;
	...
	public void postConstruct() {
		...
		atmArray = transformService.fromResponsetoArray(mainResponse);
